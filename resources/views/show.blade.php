...
@section('content')
    <a class="text-left custom-text" href="/">Back</a><div class="help-block"></div><a class="custom-text" href="/update">Update</a><div class="help-block"></div><a class="custom-text" href="{{ $firstPriceOfToday->coin->symbol }}/detail">Detail</a><br>
    In the last {{ $duration }}(s) period
    @if($percentBtc < 0)
